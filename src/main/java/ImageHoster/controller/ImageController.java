...
//        Image image = imageService.getImageByTitle(title);
        ...
        model.addAttribute("comments",imageService.getAllComments(id));
        return "images/image";
    }
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session) {
        ...
        User loggedInUser = (User)session.getAttribute("loggeduser");                    //Extracting the nameof logged user and comparing it with the user who has uploaded the image
        User ownerUser = imageService.getImage(imageId).getUser();
        ...
        if(!loggedInUser.getUsername().equals(ownerUser.getUsername())){
    ...
    private String addComment(@PathVariable("imageId") Integer imageId,@PathVariable("imageTitle") String imageTitle, Model model, Comment comment, HttpSession session){
        ...
        imageService.addComment(comment);         //add comment in database

        List<Comment> comments = imageService.getAllComments(imageId);       // get all the comments for the image and pass that in model
